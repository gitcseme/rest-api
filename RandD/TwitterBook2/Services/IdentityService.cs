    ...
    public class IdentityService : IIdentityService
    {
        ...
        public async Task<AuthenticationResult> RegisterAsync(string email, string password)
        {
            ...
            if (existingUser != null)
            {
                ...
                {
                    Errors = new[] { "User already exist with this email" }
                };
            }
            ...
            // JWT
            return await GenerateJWTAuthenticationResultAsync(newUser);
        }
        ...
        public async Task<AuthenticationResult> LoginAsync(string email, string password)
        {
            ...
            // JWT
            return await GenerateJWTAuthenticationResultAsync(user);
        }

        private async Task<AuthenticationResult> GenerateJWTAuthenticationResultAsync(IdentityUser user)
        {
        ...
        public async Task<AuthenticationResult> RefreshTokenAsync(string token, string refreshToken)
        {
            ...
            else if (storedRefreshToken.JwtId != jwtId)
        ...
        private ClaimsPrincipal GetPrincipalFromToken(string token)
        {
            ...
            try
            {
                ...
                if (!IsValidSexurityAlgorithm(validatedToken))
                    return null;
        ...
        private bool IsValidSexurityAlgorithm(SecurityToken validatedToken)
        {
